...
import GlobalLayout from "E:\\Blog\\my-blog\\node_modules\\@vuepress\\core\\lib\\client\\components\\GlobalLayout.vue"
...
export const routes = [
  {
    ...
    beforeEnter: (to, from, next) => {
      ensureAsyncComponentsLoaded("Layout", "v-78fc5431").then(next)
    },
  },
  {
    name: "v-345e3bd1",
    ...
    component: GlobalLayout,
    beforeEnter: (to, from, next) => {
      ensureAsyncComponentsLoaded("Layout", "v-345e3bd1").then(next)
    },
  },
  {
    name: "v-6291d052",
    ...
    component: GlobalLayout,
    beforeEnter: (to, from, next) => {
      ensureAsyncComponentsLoaded("Layout", "v-6291d052").then(next)
    },
  },
  {
    path: "/index.html",
