...
import GlobalLayout from "E:\\Blog\\my-blog-github\\node_modules\\@vuepress\\core\\lib\\client\\components\\GlobalLayout.vue"
...
export const routes = [
  {
    ...
    beforeEnter: (to, from, next) => {
      ensureAsyncComponentsLoaded("Layout", "v-0f027a96").then(next)
    },
  },
  {
    name: "v-8cd3671a",
    ...
    component: GlobalLayout,
    beforeEnter: (to, from, next) => {
      ensureAsyncComponentsLoaded("Layout", "v-8cd3671a").then(next)
    },
  },
  {
    path: "/index.html",
  ...
  },
  {
    ...
    component: GlobalLayout,
    beforeEnter: (to, from, next) => {
      ensureAsyncComponentsLoaded("Layout", "v-592f2315").then(next)
    },
  },
  {
    name: "v-b1564aac",
